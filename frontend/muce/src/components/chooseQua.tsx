export default function chooseQua(props:any) {
    ...
    return (
        <div>
            <form action="untangle" className="flex w-[1121px] p-[40px] flex-col items-start gap-[70px]  rounded-[20px] bg-white shadow-[0_0_20px_0_rgba(0,0,0,0.3)] relative left-[226px] top-[30px]">
                ...
                <div className="flex w-full flex-col items-end gap-[8px]">
                    <button className="px-[40px] py-[15px] text-center rounded-[20px] bg-[#227DEE] text-white text-[20px] font-bold">作成</button>
                </div>
            </form>
        </div>
    )
